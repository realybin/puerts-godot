...
#ifndef PUERTS_GODOT_PUERTS_NODEJS_BACKEND_H
#define PUERTS_GODOT_PUERTS_NODEJS_BACKEND_H
...
class PuertsNodejsBackend : public godot::Resource {
	GDCLASS(PuertsNodejsBackend, godot::Resource)
...
#endif // PUERTS_GODOT_PUERTS_NODEJS_BACKEND_H
