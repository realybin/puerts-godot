...
#ifndef PUERTS_GODOT_PUERTS_V8_BACKEND_H
#define PUERTS_GODOT_PUERTS_V8_BACKEND_H
...
class PuertsV8Backend : public godot::Resource {
	GDCLASS(PuertsV8Backend, godot::Resource)
...
#endif // PUERTS_GODOT_PUERTS_V8_BACKEND_H
